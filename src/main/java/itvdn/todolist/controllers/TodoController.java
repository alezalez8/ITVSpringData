...
//----------------------------------------------------
    ...
    @ExceptionHandler
    public ResponseEntity<String> onMissintTodoName(DataIntegrityViolationException exception) {
    ...
    public ResponseEntity<String> onMissingTodoId(NoSuchElementException exception) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(ClassUtils.getShortName(exception.getClass()) +  " No such todo was found");
    }
    @ExceptionHandler
